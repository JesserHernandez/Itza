...
const containerAside = ref(null)

function changeStyles() {
    if (containerAside.value) {
        containerAside.value.classList.toggle('sidebar-collapsed');
    }
};
...
<template>
    ...
    <div class="container-admin" v-if="
        $page.props.auth.role.includes('Administrador') ||
        $page.props.auth.role.includes('Vendedor')" ref="containerAside">
        <aside class="aside" id="aside" >
            <div class="items-aside">
                <div class="actions-aside">
                    ...
                    <button class="open-close btn-class" id="btnSidebar" @click="changeStyles">
                        <img src="/icons/icons-interface/button-menu-icon.svg" alt="" class="icons" />
                    </button>
                </div>
                <NavLink class="btn-class" v-if="$page.props.auth.role.includes('Administrador')"
                    :href="route('administrator')">
                    <img src="/icons/icons-interface/dashboard-icon.svg" alt="" class="icons" />
                ...
                <template v-if="$page.props.auth.role.includes('Administrador')">
                    <NavLink class="btn-class" :href="route('permissions.index')">
                        <img src="/icons/icons-ceramics/vasija-4-icon.svg" alt="" />
                        <span class="name-link"> Permisos </span>
                    </NavLink>

                    <NavLink class="btn-class" :href="route('roles.index')">
                        <img src="/icons/icons-ceramics/ceramic-mingle-icon.svg" alt="" class="icons" />
                    ...
                    <NavLink class="btn-class" :href="route('creative_cities.index')">
                        <img src="/icons/icons-ceramics/cuadro-patron-icon.svg" alt="" class="icons" />
                        <span class="name-link"> Ciudades creativas</span>
                    </NavLink>
                    <NavLink class="btn-class" :href="route('creative_circuits.index')">
                        <img src="/icons/icons-ceramics/city-creative-icon.svg" alt="" class="icons" />
                ...
                <template v-if="$page.props.auth.role.includes('Vendedor')">
                        ...
                        <template #trigger>
                            <div class="admin-store">
                                <button class="btn-class">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4" viewBox="0 0 10 7"
                                        fill="none" class="icons">
                                        <path
                                            d="M5 6.83335L0 1.83335L1.16667 0.666687L5 4.50002L8.83333 0.666687L10 1.83335L5 6.83335Z"
                                            fill="#F0F0F0" />
                                    </svg>
                                    <span>Admin/Tiendas</span>
                                </button>
                            </div>
                        </template>
                        <template #content>
                            <div class="content">
                                <DropdownLink :href="route('teams.create')" class="btn-class">
                                    <img src="/icons/icons-interface/store-white-icon.svg" alt="" class="icons" />
                                    <span class="hidden">Tiendas</span>
                                </DropdownLink>
                                <!-- Inicio de productos -->
                                <DropdownLink class="btn-class" :href="route('products.index')">
                                    ...
                                    <span class="hidden">Productos</span> 
                                </DropdownLink>
                                <!-- Fin de productos -->
                                <DropdownLink class="btn-class" :href="route('inventories.index')">
                                    ...
                                    <span class="hidden">Inventario</span>
                                </DropdownLink>
                                <DropdownLink class="btn-class">
                                    ...
                                    <span class="hidden">Movimientos</span>
                                </DropdownLink>
                                <DropdownLink class="btn-class">
                                    ...
                                    <span class="hidden">Ordenes</span>
                                </DropdownLink>
                            </div>
                        </template>
                    </Dropdown>
                    ...
                    <ul class="title-list">
                        <li class="item-list">
                            ...
                            }" @click="toggleSubmenu" aria-expanded="isSubmenuOpen">
                                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4" viewBox="0 0 10 7"
                                    fill="none" class="icons">
                                    <path
                                        d="M5 6.83335L0 1.83335L1.16667 0.666687L5 4.50002L8.83333 0.666687L10 1.83335L5 6.83335Z"
                            ...
                            <ul class="list-admin" v-show="isSubmenuOpen" :class="{
                                expanded: isSubmenuOpen,
                                collapsed: !isSubmenuOpen,
                            }" :aria-hidden="!isSubmenuOpen">
                                <li>
                                    <NavLink class="btn-class" :href="route('categories.index')">
                                        <img src="/icons/icons-interface/task-icon.svg" alt="" class="icons" />
                                ...
                                <li>
                                    <NavLink class="btn-class" :href="route('tags.index')">
                                        <img src="/icons/icons-interface/tag-icon.svg" alt="" class="icons" />
                    ...
                    <NavLink class="btn-class">
                        <img src="/icons/icons-interface/user-artist-white-icon.svg" alt="" class="icons" />
                        <span class="name-link"> Clientes </span>
                    </NavLink>
                    <NavLink class="btn-class">
                        <img src="/icons/icons-interface/calendar-icon.svg" alt="" class="icons" />
