...
function destroy(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            router.delete(route("creative_cities.destroy", { creative_city: id }));
            Swal.fire({
                title: "¡Eliminado!",
...
<template>
    <Head title="Creative Cities" />
    <AppLayout title="Ciudades Creativas" :href="route('creative_cities.index')">

            <HeaderAdmin
            title="Administración/Ciudades Creativas"
            icon="/icons/icons-ceramics/cuadro-patron-darker-icon.svg"
            paragraph="En este apartado podrás administrar cada una de las ciudades creativas,
        ...
        <div class="content">
            <div class="header-content-index">
                <div class="select-container">
                    <label for="creative-city">Registros por página:</label>
                    <select
                        name="creative-city"
                        id="creative-city"
                        class="select-class"
                ...
                <NavLink class="btn-class" :href="route('creative_cities.create')">
                    <span class="name-link"> Nueva ciudad </span>
                    <img
                    ...
                    <tbody>
                        <tr v-for="city in creativeCities.data" :key="city.id" class="">
                            ...
                            <td class="td-actions">
                                <NavLink
                                :href="
                                        route('creative_cities.edit', {
                                            creative_city: city.id,
                                        })
                                        "
