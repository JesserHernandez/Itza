...
class ResponseReviewController extends Controller
{
    public function index(Request $request): mixed
    {
        ...
        return Inertia::render('Customer/ResponseReview/Index', ['responseReviews' => $responseReviews, 'i' => ($request->input('page', 1) - 1) * $responseReviews->perPage()]);
    }
    public function create(): mixed
    {
        return Inertia::render('Customer/ResponseReview/Create', ['responseReview' => new ResponseReview() ]);
    }
    ...
    public function show($id): mixed
    {
        ...
        return Inertia::render('Customer/ResponseReview/Show', ['responseReview' => $responseReview ]);
    }
    public function edit($id): mixed
    {
        $responseReview = ResponseReview::findOrFail($id);
        return Inertia::render('Customer/ResponseReview/Edit', ['responseReview' => $responseReview ]);
    }
