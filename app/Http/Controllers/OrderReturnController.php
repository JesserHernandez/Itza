...
class OrderReturnController extends Controller
{
    public function index(Request $request): mixed
    {
        ...
        return Inertia::render('Vendor/OrderReturn/Index', ['order_returns' => $orderReturns, 'i' => ($request->input('page', 1) - 1) * $orderReturns->perPage()]);
    }
    public function create(): mixed
    {
        return Inertia::render('Vendor/OrderReturn/Create', ['order_return' => new OrderReturn() ]);
    }
    ...
    public function show($id): mixed
    {
        ...
        return Inertia::render('Vendor/OrderReturn/Show', ['order_return' => $orderReturn ]);
    }
    public function edit($id): mixed
    {
        $orderReturn = OrderReturn::findOrFail($id);
        return Inertia::render('Vendor/OrderReturn/Edit', ['order_return' => $orderReturn ]);
    }
