...
class ReviewResponseController extends Controller
{
    public function index(Request $request): mixed
    {
        ...
        return Inertia::render('Customer/ReviewResponse/Index', ['review_responses' => $reviewResponses, 'i' => ($request->input('page', 1) - 1) * $reviewResponses->perPage()]);
    }
    public function create(): mixed
    {
        return Inertia::render('Customer/ReviewResponse/Create', ['review_response' => new ReviewResponse() ]);
    }
    ...
    public function show($id): mixed
    {
        ...
        return Inertia::render('Customer/ReviewResponse/Show', ['review_response' => $reviewResponse ]);
    }
    public function edit($id): mixed
    {
        $reviewResponse = ReviewResponse::findOrFail($id);
        return Inertia::render('Customer/ReviewResponse/Edit', ['review_response' => $reviewResponse ]);
    }
